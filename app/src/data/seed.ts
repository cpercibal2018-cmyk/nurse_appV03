...
export const CREDENTIAL_TEMPLATES = [
  ...
  { id: 5, code: 'SCFHS', name: 'Saudi Council Registration (SCFHS)', categoryCode: 'LICENSURE', hasExpiry: true, requiresUpload: true, description: 'SCFHS registration', fields: [{ key: 'scfhs_number', label: 'SCFHS Registration Number', type: 'text', required: true }, { key: 'classification', label: 'Professional Classification', type: 'select', required: true }], displayOrder: 5, isActive: true },
  ...
  { id: 12, code: 'BLS', name: 'Basic Life Support (BLS)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Basic Life Support certification — CPR and airway basics', fields: [], displayOrder: 12, isActive: true },
  { id: 13, code: 'ACLS', name: 'Advanced Cardiac Life Support (ACLS)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Advanced Cardiac Life Support — adult cardiac emergencies', fields: [], displayOrder: 13, isActive: true },
  { id: 14, code: 'PALS', name: 'Pediatric Advanced Life Support (PALS)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Pediatric Advanced Life Support — child emergencies', fields: [], displayOrder: 14, isActive: true },
  { id: 15, code: 'NRP', name: 'Neonatal Resuscitation Program (NRP)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Neonatal Resuscitation Program — newborn resuscitation', fields: [], displayOrder: 15, isActive: true },
