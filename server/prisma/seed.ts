...
const CREDENTIAL_TEMPLATES = [
  { id: 1, code: 'PASSPORT', name: 'Passport', categoryCode: 'IDENTITY', hasExpiry: true, requiresUpload: true, description: 'International passport', fields: [{ key: 'passport_number', label: 'Passport Number', type: 'text', required: true }], displayOrder: 1, isActive: true },
  { id: 2, code: 'IQAMA', name: 'Resident ID (Iqama)', categoryCode: 'IDENTITY', hasExpiry: true, requiresUpload: true, description: 'Saudi Iqama', fields: [], displayOrder: 2, isActive: true },
  { id: 3, code: 'HOSPITAL_ID', name: 'Hospital ID', categoryCode: 'IDENTITY', hasExpiry: true, requiresUpload: true, description: 'Hospital ID card', fields: [], displayOrder: 3, isActive: true },
  { id: 4, code: 'PROF_LICENSE', name: 'Professional License', categoryCode: 'LICENSURE', hasExpiry: true, requiresUpload: true, description: 'Professional license', fields: [], displayOrder: 4, isActive: true },
  { id: 5, code: 'SCFHS', name: 'Saudi Council Registration (SCFHS)', categoryCode: 'LICENSURE', hasExpiry: true, requiresUpload: true, description: 'SCFHS registration', fields: [], displayOrder: 5, isActive: true },
  ...
  { id: 7, code: 'MALPRACTICE', name: 'Malpractice Insurance', categoryCode: 'LIABILITY', hasExpiry: true, requiresUpload: true, description: 'Medical malpractice / professional liability insurance', fields: [], displayOrder: 7, isActive: true },
  ...
  { id: 12, code: 'BLS', name: 'Basic Life Support (BLS)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Basic Life Support certification', fields: [], displayOrder: 12, isActive: true },
  { id: 13, code: 'ACLS', name: 'Advanced Cardiac Life Support (ACLS)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Advanced Cardiac Life Support', fields: [], displayOrder: 13, isActive: true },
  { id: 14, code: 'PALS', name: 'Pediatric Advanced Life Support (PALS)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Pediatric Advanced Life Support', fields: [], displayOrder: 14, isActive: true },
  { id: 15, code: 'NRP', name: 'Neonatal Resuscitation Program (NRP)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Neonatal Resuscitation Program', fields: [], displayOrder: 15, isActive: true },
  { id: 16, code: 'BICSL', name: 'Basic Infection Control (BICSL)', categoryCode: 'LIFE_SUPPORT', hasExpiry: true, requiresUpload: true, description: 'Basic Infection Control Skills License', fields: [], displayOrder: 16, isActive: true },
];
